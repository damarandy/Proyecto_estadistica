...
?>
     ...
     <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
             ...
             <label class="col-form-label"><span class="error"> </span>MATERIA</label>
              <select name="materia" id="materia" style="border:double;background:#E5E7E9;color:write">
              ...
              <select name="juzgado" id="juzgado" style="border:double;background:#E5E7E9;color:write">
            ...
            <label><span class="error"> </span>PROVINCIA</label>
            <select name="provincia" id="provincia" style="border:double;background:#E5E7E9;color:write">
            ...
            <label class="col-form-label"><span class="error"> </span>NIVEL</label>
             <select name="nivel" id="nivel" style="border:double;background:#E5E7E9;color:write">
             ...
             <select name="mes" id="mes" style="border:double;background:#E5E7E9;color:write">
             ...
             <select name="año" id="año" style="border:double;background:#E5E7E9;color:write">
            ...
            <select name="tipomovi" id="tipomovi" style="border:double;background:#E5E7E9;color:write">
